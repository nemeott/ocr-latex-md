...
def load_image(image_path: str) -> np.ndarray:
    ...
    #in this case, claude just gave me the imread function, but I coded the function by hand, I just use the chat interface to see how I could load all these images in 
...
def preprocess(image: np.ndarray) -> np.ndarray:
    ...
    # I utilized LLM to help me understand what methods I needed to use to implement the image processing methods I needed for what I wanted
    #So I told that I knew what our pipeline should look like in the sense each image should be converted to grayscale, and then the contrast should be normalized to help with our models. and then Gaussian blur.
    
    #Claude gave me the function that were avalible inside opencv, and in some cases it wrote some lines of code. I have flagged which lines have been written by claude 
    ...
    #THis line was generated by claude 
    ...
    #This line was also generated by claude 
...
def _load_dataset(math_split, text_split, n_math=None, n_text=None, n_jobs=-2):
    ...
    for ds, img_key, txt_key, type_label, n_cap in [
        ...
        #I watned to do parellel processing to help since we were dealing with a very large dataset but was quite unsure of how to do it
        #So here, claude generated the code below to help with the parllel processing to speed up laoding in the datasets 
